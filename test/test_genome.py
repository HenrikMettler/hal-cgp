...
def test_only_silent_mutations(genome_params, mutation_rate, rng_seed):
    ...
    gene_to_be_mutated_active = active_regions[-1] * (genome.primitives.max_arity + 1) # function gene of the 1st active hidden gene, should always be mutable
    gene_to_be_mutated_non_active = 4 * (genome.primitives.max_arity + 1) # 4 is a non active gene in this seed
    print(active_regions, gene_to_be_mutated_non_active // (genome.primitives.max_arity + 1) )
    ...
    genome.select_gene_indices = select_gene_indices_silent
    ...
    genome.select_gene_indices = select_gene_indices_non_silent
